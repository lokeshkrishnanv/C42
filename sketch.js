...
function preload(){
    ...
    bestmanIMG = loadImage("Walking Frame/batman.png")
...
function draw(){
    ...
    bat= createSprite(0, Math.round(random(480,670)));
    ...
    if(frameCount >= 200){
        bat.visible = false;
        var bestman = createSprite(230,560);
        bestman.addImage("bestmanIMG", bestmanIMG)
        bestman.scale = 0.7;
